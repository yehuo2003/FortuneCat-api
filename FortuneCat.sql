...
SET NAMES UTF8;
#如果存在，删除数据库heilan
DROP DATABASE IF EXISTS FortuneCat;

#创建数据库heilan，指定编码类型为utf8
CREATE DATABASE FortuneCat CHARSET=UTF8;
...
#插入管理员信息表信息
INSERT INTO cat_admin VALUES
(NULL,'admin',PASSWORD('123456')),
(NULL,'boss',PASSWORD('888888')),
(NULL,'lin',PASSWORD('123456'));
...
#插入菜品类别信息
INSERT INTO cat_category VALUES
(NULL,'肉类'),
(NULL,'海鲜河鲜'),
(NULL,'丸滑类'),
(NULL,'蔬菜豆制品'),
...
#订单详情
CREATE TABLE cat_order_detail(
  oid INT PRIMARY KEY AUTO_INCREMENT,
  dishId INT,       /*菜品编号*/
  dishCount INT,    /*份数*/
  customerName VARCHAR(32),    /*顾客名称*/
  orderId INT,      /*订单编号*/
  FOREIGN KEY(dishId) REFERENCES cat_dish(did),
  FOREIGN KEY(orderId) REFERENCES cat_order(oid)
);

#插入订单信息
INSERT INTO cat_order_detail VALUES
(NULL, '50', '2', '丁丁', '100000'),
(NULL, '24', '2', '丁丁', '100001'),
(NULL, '37', '1', '当当', '100002'),
(NULL, '18', '3', '豆豆', '100003'),
